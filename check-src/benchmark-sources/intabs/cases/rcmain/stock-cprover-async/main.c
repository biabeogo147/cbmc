...
void main(void){
 ...
 __CPROVER_ASYNC_3:
 ir_devnode_ldvwrapper(((void *)0));

 pthread_t store_protocols_ldvthread;
 __CPROVER_ASYNC_4:
 store_protocols_ldvwrapper(((void *)0));

 pthread_t show_protocols_ldvthread;
 __CPROVER_ASYNC_5:
 show_protocols_ldvwrapper(((void *)0));
 */
...
/*
 ...
 __CPROVER_ASYNC_9:
 rc_dev_uevent_ldvwrapper(((void *)0));


 pthread_t rc_dev_release_ldvthread;
 __CPROVER_ASYNC_10:
 rc_dev_release_ldvwrapper(((void *)0));
