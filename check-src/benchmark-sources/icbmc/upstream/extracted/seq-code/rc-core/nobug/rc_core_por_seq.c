...
__inline static void __set_bit(int nr , unsigned long volatile *addr )
{
  ...
  {
schedule_irq();
  __asm__ volatile ("bts %1,%0": "+m" (*((long volatile *)addr)): "Ir" (nr): "memory"); // W-W dependency
schedule_irq();
  return;
}
}
__inline static void __clear_bit(int nr , unsigned long volatile *addr )
{
  ...
  {
schedule_irq();
  __asm__ volatile ("btr %1,%0": "+m" (*((long volatile *)addr)): "Ir" (nr)); // W-W dependency
schedule_irq();
  return;
}
}
...
__inline static raw_spinlock_t *spinlock_check(spinlock_t *lock )
{
  ...
  {
schedule_irq();
  raw_spinlock_t* result = (& lock->ldv_5961.rlock); // W-W dependency
schedule_irq();
  return result;
}
}
...
__inline static void spin_unlock_irqrestore(spinlock_t *lock , unsigned long flags )
{
  ...
  {
schedule_irq();
  _raw_spin_unlock_irqrestore(& lock->ldv_5961.rlock, flags); // W-W dependency
schedule_irq();
  return;
}
}
...
__inline static char const *kobject_name(struct kobject const *kobj )
{
  ...
  {
schedule_irq();
  char const* result = ((char const *)kobj->name); // W-W dependency
schedule_irq();
  return result;
}
}
...
{
schedule_irq();
  char const *tmp ; // W-W dependency
schedule_irq();
  char const* result;
  {
schedule_irq();
  if ((unsigned long )dev->init_name != (unsigned long )((char const * )0)) { // R-W dependency
schedule_irq();
    result = ((char const *)dev->init_name); // W-W dependency
schedule_irq();
   return result;
  } else {
...
{
schedule_irq();
  void *tmp ; // W-W dependency
schedule_irq();

  {
schedule_irq();
  tmp = dev_get_drvdata((struct device const *)(& dev->dev)); // W-W dependency
schedule_irq();
  return (tmp); // W-W dependency
}
}
...
{
schedule_irq();
  void *tmp___2 ; // W-W dependency
schedule_irq();

  {
schedule_irq();
  tmp___2 = __kmalloc(size, flags); // W-W dependency
schedule_irq();
  return (tmp___2); // W-W dependency
}
}
...
static int ir_resize_table(struct rc_map *rc_map , gfp_t gfp_flags )
{
  ...
  {
schedule_irq();
  oldalloc = rc_map->alloc; // W-W dependency
schedule_irq();
  newalloc = oldalloc; // W-W dependency
schedule_irq();
  oldscan = rc_map->scan; // W-W dependency
schedule_irq();
...
schedule_irq();
    newalloc = newalloc * 2U; // W-W dependency
schedule_irq();
    if (rc_core_debug > 0) {
schedule_irq();
      descriptor.modname = "rc_core"; // W-W dependency
schedule_irq();
      descriptor.function = "ir_resize_table"; // W-W dependency
schedule_irq();
      descriptor.filename = "/work/zakharov/bench-tests/cpa-1/work/current--X--drivers/media/rc/rc-core.ko--X--deg2_cpalinux-3.8-rc1--X--32_7a--X--cpachecker/linux-3.8-rc1/csd_deg_dscv/13/dscv_tempdir/dscv/ri/32_7a/drivers/media/rc/rc-main.c.prepared"; // W-W dependency
schedule_irq();
      descriptor.format = "%s: Growing table to %u bytes\n"; // W-W dependency
schedule_irq();
      descriptor.lineno = 228U; // W-W dependency
schedule_irq();
      descriptor.flags = 0U; // W-W dependency
schedule_irq();
      tmp = __builtin_expect((long )descriptor.flags & 1L, 0L); // W-W dependency
schedule_irq();
      if (tmp != 0L) { // R-W dependency
schedule_irq();
        __dynamic_pr_debug(& descriptor, "%s: Growing table to %u bytes\n", "ir_resize_table", // R-W dependency
                           newalloc);
      } else {
...
schedule_irq();
  if (rc_map->len * 3U < rc_map->size && oldalloc > 256U) { // R-W dependency
schedule_irq();
    newalloc = newalloc / 2U; // W-W dependency
schedule_irq();
    if (rc_core_debug > 0) {
schedule_irq();
      descriptor___0.modname = "rc_core"; // W-W dependency
schedule_irq();
      descriptor___0.function = "ir_resize_table"; // W-W dependency
schedule_irq();
      descriptor___0.filename = "/work/zakharov/bench-tests/cpa-1/work/current--X--drivers/media/rc/rc-core.ko--X--deg2_cpalinux-3.8-rc1--X--32_7a--X--cpachecker/linux-3.8-rc1/csd_deg_dscv/13/dscv_tempdir/dscv/ri/32_7a/drivers/media/rc/rc-main.c.prepared"; // W-W dependency
schedule_irq();
      descriptor___0.format = "%s: Shrinking table to %u bytes\n"; // W-W dependency
schedule_irq();
      descriptor___0.lineno = 234U; // W-W dependency
schedule_irq();
      descriptor___0.flags = 0U; // W-W dependency
schedule_irq();
      tmp___0 = __builtin_expect((long )descriptor___0.flags & 1L, 0L); // W-W dependency
schedule_irq();
      if (tmp___0 != 0L) { // R-W dependency
schedule_irq();
...
schedule_irq();
  if (newalloc == oldalloc) { // R-W dependency
    return (0);
  } else {
...
schedule_irq();
  newscan = (struct rc_map_table *)tmp___1; // W-W dependency
schedule_irq();
  if ((unsigned long )newscan == (unsigned long )((struct rc_map_table *)0)) { // R-W dependency
    if (rc_core_debug > 0) {
schedule_irq();
      descriptor___1.modname = "rc_core"; // W-W dependency
schedule_irq();
      descriptor___1.function = "ir_resize_table"; // W-W dependency
schedule_irq();
      descriptor___1.filename = "/work/zakharov/bench-tests/cpa-1/work/current--X--drivers/media/rc/rc-core.ko--X--deg2_cpalinux-3.8-rc1--X--32_7a--X--cpachecker/linux-3.8-rc1/csd_deg_dscv/13/dscv_tempdir/dscv/ri/32_7a/drivers/media/rc/rc-main.c.prepared"; // W-W dependency
schedule_irq();
      descriptor___1.format = "%s: Failed to kmalloc %u bytes\n"; // W-W dependency
schedule_irq();
      descriptor___1.lineno = 242U; // W-W dependency
schedule_irq();
      descriptor___1.flags = 0U; // W-W dependency
schedule_irq();
      tmp___2 = __builtin_expect((long )descriptor___1.flags & 1L, 0L); // W-W dependency
schedule_irq();
      if (tmp___2 != 0L) { // R-W dependency
schedule_irq();
...
schedule_irq();
  __len = (unsigned long )rc_map->len * 8UL; // W-W dependency
schedule_irq();
  __ret = __builtin_memcpy((void *)newscan, (void const *)rc_map->scan, __len); // W-W dependency
schedule_irq();
  rc_map->scan = newscan; // R-W dependency
schedule_irq();
  rc_map->alloc = newalloc; // R-W dependency
  rc_map->size = rc_map->alloc / 8U;
schedule_irq();
  kfree((void const *)oldscan); // R-W dependency
  return (0);
}
}
                                      ...
                                      unsigned int index , unsigned int new_keycode )
{
  ...
  {
schedule_irq();
  old_keycode = (int )(rc_map->scan + (unsigned long )index)->keycode; // W-W dependency
schedule_irq();
...
schedule_irq();
      descriptor.modname = "rc_core"; // W-W dependency
schedule_irq();
      descriptor.function = "ir_update_mapping"; // W-W dependency
schedule_irq();
      descriptor.filename = "/work/zakharov/bench-tests/cpa-1/work/current--X--drivers/media/rc/rc-core.ko--X--deg2_cpalinux-3.8-rc1--X--32_7a--X--cpachecker/linux-3.8-rc1/csd_deg_dscv/13/dscv_tempdir/dscv/ri/32_7a/drivers/media/rc/rc-main.c.prepared"; // W-W dependency
schedule_irq();
      descriptor.format = "%s: #%d: Deleting scan 0x%04x\n"; // W-W dependency
schedule_irq();
      descriptor.lineno = 276U; // W-W dependency
schedule_irq();
      descriptor.flags = 0U; // W-W dependency
schedule_irq();
      tmp = __builtin_expect((long )descriptor.flags & 1L, 0L); // W-W dependency
...
schedule_irq();
      descriptor___0.modname = "rc_core"; // W-W dependency
schedule_irq();
      descriptor___0.function = "ir_update_mapping"; // W-W dependency
schedule_irq();
      descriptor___0.filename = "/work/zakharov/bench-tests/cpa-1/work/current--X--drivers/media/rc/rc-core.ko--X--deg2_cpalinux-3.8-rc1--X--32_7a--X--cpachecker/linux-3.8-rc1/csd_deg_dscv/13/dscv_tempdir/dscv/ri/32_7a/drivers/media/rc/rc-main.c.prepared"; // W-W dependency
schedule_irq();
      descriptor___0.format = "%s: #%d: %s scan 0x%04x with key 0x%04x\n"; // W-W dependency
schedule_irq();
      descriptor___0.lineno = 284U; // W-W dependency
schedule_irq();
      descriptor___0.flags = 0U; // W-W dependency
schedule_irq();
      tmp___0 = __builtin_expect((long )descriptor___0.flags & 1L, 0L); // W-W dependency
...
schedule_irq();
  if (old_keycode != 0) { // R-W dependency
...
schedule_irq();
    ...
    ldv_23222: ;
schedule_irq();
    if ((rc_map->scan + (unsigned long )i)->keycode == (u32 )old_keycode) { // R-W dependency
...
schedule_irq();
    i = i + 1; // W-W dependency
schedule_irq();
    ldv_23223: ;
schedule_irq();
    if ((unsigned int )i < rc_map->len) { // R-W dependency
      goto ldv_23222;
    } else {
                                          ...
                                          unsigned int scancode , bool resize )
{
  ...
  if (dev->scanmask != 0U) {
schedule_irq();
    scancode = dev->scanmask & scancode; // W-W dependency
schedule_irq();
  } else {
...
schedule_irq();
  ...
  ldv_23232: ;
schedule_irq();
  if ((rc_map->scan + (unsigned long )i)->scancode == scancode) { // R-W dependency
    return (i);
  } else {
...
schedule_irq();
  i = i + 1U; // W-W dependency
schedule_irq();
  ldv_23233: ;
schedule_irq();
  if (rc_map->len > i) { // R-W dependency
    goto ldv_23232;
  } else {
...
schedule_irq();
      tmp = ir_resize_table(rc_map, 32U); // W-W dependency
schedule_irq();
      if (tmp != 0) { // R-W dependency
        return (4294967295U);
      } else {
...
schedule_irq();
  if (rc_map->len > i) { // R-W dependency
schedule_irq();
    memmove((void *)rc_map->scan + (unsigned long )(i + 1U), (void const *)rc_map->scan + (unsigned long )i, // R-W dependency
            (unsigned long )(rc_map->len - i) * 8UL);
  } else {

  }
schedule_irq();
  (rc_map->scan + (unsigned long )i)->scancode = scancode; // R-W dependency
schedule_irq();
  (rc_map->scan + (unsigned long )i)->keycode = 0U; // R-W dependency
  rc_map->len = rc_map->len + 1U;
  return (i);
}
}
...
schedule_irq();
  rdev = (struct rc_dev *)tmp; // W-W dependency
schedule_irq();
  rc_map = & rdev->rc_map; // W-W dependency
schedule_irq();
  retval = 0; // W-W dependency
schedule_irq();
  tmp___0 = spinlock_check(& rc_map->lock);
schedule_irq();
  flags = _raw_spin_lock_irqsave(tmp___0); // W-W dependency
schedule_irq();
  if ((int )ke->flags & 1) {
schedule_irq();
    index = (unsigned int )ke->index; // W-W dependency
schedule_irq();
    if (rc_map->len <= index) { // R-W dependency
schedule_irq();
      retval = -22; // W-W dependency
schedule_irq();
      goto out;
    } else {
...
schedule_irq();
    retval = input_scancode_to_scalar(ke, & scancode); // W-W dependency
schedule_irq();
    if (retval != 0) { // R-W dependency
      goto out;
    } else {

    }
schedule_irq();
    index = ir_establish_scancode(rdev, rc_map, scancode, 1); // W-W dependency
schedule_irq();
    if (rc_map->len <= index) { // R-W dependency
schedule_irq();
      retval = -12; // W-W dependency
schedule_irq();
      goto out;
    } else {
...
schedule_irq();
  *old_keycode = ir_update_mapping(rdev, rc_map, index, ke->keycode); // W-W dependency
schedule_irq();
  out:
...
static unsigned int ir_lookup_by_scancode(struct rc_map const *rc_map , unsigned int scancode )
{
  ...
  {
schedule_irq();
  start = 0; // W-W dependency
schedule_irq();
  end = (int )((unsigned int )rc_map->len - 1U); // W-W dependency
schedule_irq();
  goto ldv_23270;
  ldv_23269:
schedule_irq();
  mid = (start + end) / 2; // W-W dependency
schedule_irq();
  if ((rc_map->scan + (unsigned long )mid)->scancode < scancode) { // R-W dependency
schedule_irq();
    start = mid + 1; // W-W dependency
schedule_irq();
  } else
schedule_irq();
  if ((rc_map->scan + (unsigned long )mid)->scancode > scancode) { // R-W dependency
schedule_irq();
    end = mid + -1; // W-W dependency
schedule_irq();
  } else {
...
schedule_irq();
    retval = input_scancode_to_scalar((struct input_keymap_entry const *)ke, & scancode); // W-W dependency
schedule_irq();
    if (retval != 0) { // R-W dependency
      goto out;
    } else {
...
schedule_irq();
    index = ir_lookup_by_scancode((struct rc_map const *)rc_map, scancode); // W-W dependency
schedule_irq();
  }
schedule_irq();
  if (rc_map->len > index) { // R-W dependency
schedule_irq();
    entry = rc_map->scan + (unsigned long )index; // W-W dependency
schedule_irq();
    ke->index = (__u16 )index; // W-W dependency
schedule_irq();
    ke->keycode = entry->keycode; // W-W dependency
schedule_irq();
    ke->len = 4U; // W-W dependency
schedule_irq();
    __len = 4UL; // W-W dependency
schedule_irq();
    if (__len > 63UL) { // R-W dependency
schedule_irq();
      __ret = __memcpy((void *)(& ke->scancode), (void const *)(& entry->scancode), __len); // W-W dependency
schedule_irq();
    } else {
schedule_irq();
      __ret = __builtin_memcpy((void *)(& ke->scancode), (void const *)(& entry->scancode), __len); // W-W dependency
schedule_irq();
    }
  } else
  if (((int )ke->flags & 1) == 0) {
...
schedule_irq();
  tmp___0 = kasprintf(208U, "rc/%s", tmp); // W-W dependency
schedule_irq();
  return (tmp___0);
}
}
...
schedule_irq();
  __mptr = (struct device const *)device; // W-W dependency
schedule_irq();
  dev = (struct rc_dev *)__mptr; // W-W dependency
schedule_irq();
  tmp = buf; // W-W dependency
schedule_irq();
  if ((unsigned long )dev == (unsigned long )((struct rc_dev *)0)) { // R-W dependency
    return (-22L);
  } else {
...
schedule_irq();
  if ((unsigned int )dev->driver_type == 0U) { // R-W dependency

schedule_irq();
    enabled = (u64 )dev->rc_map.rc_type; // W-W dependency
schedule_irq();
    allowed = dev->allowed_protos; // W-W dependency
schedule_irq();
...
schedule_irq();
  if ((unsigned long )dev->raw != (unsigned long )((struct ir_raw_event_ctrl *)0)) { // R-W dependency
schedule_irq();
    enabled = (dev->raw)->enabled_protocols; // W-W dependency
schedule_irq();
    allowed = ir_raw_get_allowed_protocols(); // W-W dependency
schedule_irq();
...
schedule_irq();
    //test_bug = 0;
    //if (test_bug==1) irq_err();
   //if(!((unsigned int )dev->driver_type != 0U && (unsigned long )dev->raw == (unsigned long )((struct ir_raw_event_ctrl *)0))) irq_err(); //consistency check // W-W dependency
...
schedule_irq();
    descriptor.modname = "rc_core"; // W-W dependency
schedule_irq();
    descriptor.function = "show_protocols"; // W-W dependency
schedule_irq();
    descriptor.filename = "/work/zakharov/bench-tests/cpa-1/work/current--X--drivers/media/rc/rc-core.ko--X--deg2_cpalinux-3.8-rc1--X--32_7a--X--cpachecker/linux-3.8-rc1/csd_deg_dscv/13/dscv_tempdir/dscv/ri/32_7a/drivers/media/rc/rc-main.c.prepared"; // W-W dependency
schedule_irq();
    descriptor.format = "%s: allowed - 0x%llx, enabled - 0x%llx\n"; // W-W dependency
schedule_irq();
    descriptor.lineno = 851U; // W-W dependency
schedule_irq();
    descriptor.flags = 0U; // W-W dependency
schedule_irq();
    tmp___0 = __builtin_expect((long )descriptor.flags & 1L, 0L); // W-W dependency
schedule_irq();
    if (tmp___0 != 0L) { // R-W dependency
schedule_irq();
...
schedule_irq();
  ...
  ldv_23435: ;
schedule_irq();
  if (((allowed & enabled) & proto_names[i].type) != 0ULL) { // R-W dependency
schedule_irq();
    tmp___1 = sprintf(tmp, "[%s] ", proto_names[i].name); // W-W dependency
schedule_irq();
    tmp = tmp + (unsigned long )tmp___1; // W-W dependency
schedule_irq();
  } else
schedule_irq();
  if ((proto_names[i].type & allowed) != 0ULL) { // R-W dependency
schedule_irq();
    tmp___2 = sprintf(tmp, "%s ", proto_names[i].name); // W-W dependency
schedule_irq();
    tmp = tmp + (unsigned long )tmp___2; // W-W dependency
schedule_irq();
  } else {
...
schedule_irq();
  if ((proto_names[i].type & allowed) != 0ULL) { // R-W dependency
schedule_irq();
    allowed = ~ proto_names[i].type & allowed; // W-W dependency
schedule_irq();
  } else {
...
schedule_irq();
  ldv_23436: ;
schedule_irq();
  if ((unsigned int )i <= 11U) { // R-W dependency
    goto ldv_23435;
  } else {

  }
schedule_irq();
  if ((unsigned long )tmp != (unsigned long )buf) { // R-W dependency
schedule_irq();
    tmp = tmp - 1; // W-W dependency
schedule_irq();
  } else {

  }
schedule_irq();
  *tmp = 10; // W-W dependency
schedule_irq();
  // Peter
...
schedule_irq();
  if ((unsigned int )dev->driver_type == 0U) { // R-W dependency
schedule_irq();
    type = (u64 )dev->rc_map.rc_type; // W-W dependency
schedule_irq();
  } else
schedule_irq();
  if ((unsigned long )dev->raw != (unsigned long )((struct ir_raw_event_ctrl *)0)) { // R-W dependency
schedule_irq();
    type = (dev->raw)->enabled_protocols; // W-W dependency
schedule_irq();
  } else {
     // Lihao
     //test_bug=1;
...
schedule_irq();
    dev->raw = &r; // this will violate the consistency check // W-W dependency
schedule_irq();
...
schedule_irq();
      descriptor.modname = "rc_core"; // W-W dependency
schedule_irq();
      descriptor.function = "store_protocols"; // W-W dependency
schedule_irq();
      descriptor.filename = "/work/zakharov/bench-tests/cpa-1/work/current--X--drivers/media/rc/rc-core.ko--X--deg2_cpalinux-3.8-rc1--X--32_7a--X--cpachecker/linux-3.8-rc1/csd_deg_dscv/13/dscv_tempdir/dscv/ri/32_7a/drivers/media/rc/rc-main.c.prepared"; // W-W dependency
schedule_irq();
      descriptor.format = "%s: Protocol switching not supported\n"; // W-W dependency
schedule_irq();
      descriptor.lineno = 916U; // W-W dependency
schedule_irq();
      descriptor.flags = 0U; // W-W dependency
schedule_irq();
      tmp___0 = __builtin_expect((long )descriptor.flags & 1L, 0L); // W-W dependency
...
schedule_irq();
  ...
  ldv_23469: ;
schedule_irq();
  if ((int )((signed char )*tmp) == 0) { // R-W dependency
    goto ldv_23460;
  } else {

  }
schedule_irq();
  if ((int )((signed char )*tmp) == 43) { // R-W dependency
schedule_irq();
    enable = 1; // W-W dependency
schedule_irq();
    disable = 0; // W-W dependency
schedule_irq();
    tmp = tmp + 1; // W-W dependency
schedule_irq();
  } else
schedule_irq();
  if ((int )((signed char )*tmp) == 45) { // R-W dependency
schedule_irq();
    enable = 0; // W-W dependency
schedule_irq();
    disable = 1; // W-W dependency
schedule_irq();
    tmp = tmp + 1; // W-W dependency
schedule_irq();
  } else {
...
schedule_irq();
  ...
  ldv_23464:
schedule_irq();
  tmp___1 = strcasecmp(tmp, (char const *)proto_names[i].name); // W-W dependency
schedule_irq();
  if (tmp___1 == 0) { // R-W dependency
schedule_irq();
    mask = proto_names[i].type; // W-W dependency
schedule_irq();
    goto ldv_23463;
  } else {
...
schedule_irq();
  ...
  ldv_23463: ;
schedule_irq();
  if (i == 12) { // R-W dependency
    if (rc_core_debug > 0) {
schedule_irq();
      descriptor___0.modname = "rc_core"; // W-W dependency
schedule_irq();
      descriptor___0.function = "store_protocols"; // W-W dependency
schedule_irq();
      descriptor___0.filename = "/work/zakharov/bench-tests/cpa-1/work/current--X--drivers/media/rc/rc-core.ko--X--deg2_cpalinux-3.8-rc1--X--32_7a--X--cpachecker/linux-3.8-rc1/csd_deg_dscv/13/dscv_tempdir/dscv/ri/32_7a/drivers/media/rc/rc-main.c.prepared"; // W-W dependency
schedule_irq();
      descriptor___0.format = "%s: Unknown protocol: \'%s\'\n"; // W-W dependency
schedule_irq();
      descriptor___0.lineno = 946U; // W-W dependency
schedule_irq();
      descriptor___0.flags = 0U; // W-W dependency
schedule_irq();
      tmp___2 = __builtin_expect((long )descriptor___0.flags & 1L, 0L); // W-W dependency
schedule_irq();
      if (tmp___2 != 0L) { // R-W dependency
schedule_irq();
        __dynamic_pr_debug(& descriptor___0, "%s: Unknown protocol: \'%s\'\n", "store_protocols", // R-W dependency
                           tmp);
      } else {
...
schedule_irq();
  count = count + 1; // W-W dependency
schedule_irq();
  if ((int )enable) { // R-W dependency
schedule_irq();
    type = type | mask; // W-W dependency
schedule_irq();
  } else
schedule_irq();
  if ((int )disable) { // R-W dependency
schedule_irq();
    type = ~ mask & type; // W-W dependency
schedule_irq();
  } else {
schedule_irq();
    type = mask; // W-W dependency
schedule_irq();
  }
  ldv_23470:
schedule_irq();
...
schedule_irq();
  tmp = (char const *)tmp___3; // W-W dependency
schedule_irq();
  if ((unsigned long )tmp != (unsigned long )((char const *)0)) { // R-W dependency
    goto ldv_23469;
  } else {
  }
  ldv_23460: ;
schedule_irq();
  if (count == 0) { // R-W dependency
    if (rc_core_debug > 0) {
schedule_irq();
      descriptor___1.modname = "rc_core"; // W-W dependency
schedule_irq();
      descriptor___1.function = "store_protocols"; // W-W dependency
schedule_irq();
      descriptor___1.filename = "/work/zakharov/bench-tests/cpa-1/work/current--X--drivers/media/rc/rc-core.ko--X--deg2_cpalinux-3.8-rc1--X--32_7a--X--cpachecker/linux-3.8-rc1/csd_deg_dscv/13/dscv_tempdir/dscv/ri/32_7a/drivers/media/rc/rc-main.c.prepared"; // W-W dependency
schedule_irq();
      descriptor___1.format = "%s: Protocol not specified\n"; // W-W dependency
schedule_irq();
      descriptor___1.lineno = 961U; // W-W dependency
schedule_irq();
      descriptor___1.flags = 0U; // W-W dependency
schedule_irq();
      tmp___4 = __builtin_expect((long )descriptor___1.flags & 1L, 0L); // W-W dependency
schedule_irq();
      if (tmp___4 != 0L) { // R-W dependency
...
schedule_irq();
  if ((unsigned long )dev->change_protocol != (unsigned long )((int (*)(struct rc_dev * , // R-W dependency
                                                                        u64 * ))0)) {
schedule_irq();
    rc = (*(dev->change_protocol))(dev, & type); // W-W dependency
schedule_irq();
    if (rc < 0) { // R-W dependency
      if (rc_core_debug > 0) {
schedule_irq();
        descriptor___2.modname = "rc_core"; // W-W dependency
schedule_irq();
        descriptor___2.function = "store_protocols"; // W-W dependency
schedule_irq();
        descriptor___2.filename = "/work/zakharov/bench-tests/cpa-1/work/current--X--drivers/media/rc/rc-core.ko--X--deg2_cpalinux-3.8-rc1--X--32_7a--X--cpachecker/linux-3.8-rc1/csd_deg_dscv/13/dscv_tempdir/dscv/ri/32_7a/drivers/media/rc/rc-main.c.prepared"; // W-W dependency
schedule_irq();
        descriptor___2.format = "%s: Error setting protocols to 0x%llx\n"; // W-W dependency
schedule_irq();
        descriptor___2.lineno = 970U; // W-W dependency
schedule_irq();
        descriptor___2.flags = 0U; // W-W dependency
schedule_irq();
        tmp___5 = __builtin_expect((long )descriptor___2.flags & 1L, 0L); // W-W dependency
schedule_irq();
        if (tmp___5 != 0L) { // R-W dependency
schedule_irq();
...
schedule_irq();
    flags = _raw_spin_lock_irqsave(tmp___6); // W-W dependency
schedule_irq();
    dev->rc_map.rc_type = (enum rc_type )type; // W-W dependency
schedule_irq();
    spin_unlock_irqrestore(& dev->rc_map.lock, flags);
  } else {
schedule_irq();
    (dev->raw)->enabled_protocols = type; // R-W dependency
  }
  if (rc_core_debug > 0) {
schedule_irq();
    descriptor___3.modname = "rc_core"; // W-W dependency
schedule_irq();
    descriptor___3.function = "store_protocols"; // W-W dependency
schedule_irq();
    descriptor___3.filename = "/work/zakharov/bench-tests/cpa-1/work/current--X--drivers/media/rc/rc-core.ko--X--deg2_cpalinux-3.8-rc1--X--32_7a--X--cpachecker/linux-3.8-rc1/csd_deg_dscv/13/dscv_tempdir/dscv/ri/32_7a/drivers/media/rc/rc-main.c.prepared"; // W-W dependency
schedule_irq();
    descriptor___3.format = "%s: Current protocol(s): 0x%llx\n"; // W-W dependency
schedule_irq();
    descriptor___3.lineno = 985U; // W-W dependency
schedule_irq();
    descriptor___3.flags = 0U; // W-W dependency
schedule_irq();
    tmp___7 = __builtin_expect((long )descriptor___3.flags & 1L, 0L); // W-W dependency
schedule_irq();
    if (tmp___7 != 0L) { // R-W dependency
schedule_irq();
...
schedule_irq();
  ret = (ssize_t )len; // W-W dependency
schedule_irq();
  out:
  // Peter
...
schedule_irq();
  dev = (struct rc_dev *)__mptr; // W-W dependency
schedule_irq();
  if ((unsigned long )dev == (unsigned long )((struct rc_dev *)0) || (unsigned long )dev->input_dev == (unsigned long )((struct input_dev *)0)) { // W-W dependency
schedule_irq();
    return (-19);
  } else {
...
schedule_irq();
  if ((unsigned long )dev->rc_map.name != (unsigned long )((char const *)0)) { // R-W dependency
schedule_irq();
    tmp = add_uevent_var(env, "NAME=%s", dev->rc_map.name); // W-W dependency
schedule_irq();
    err = tmp; // W-W dependency
schedule_irq();
    if (err != 0) { // R-W dependency
      return (err);
    } else {
...
schedule_irq();
  if ((unsigned long )dev->driver_name != (unsigned long )((char *)0)) { // R-W dependency
schedule_irq();
    tmp___0 = add_uevent_var(env, "DRV_NAME=%s", dev->driver_name); // W-W dependency
schedule_irq();
    err___0 = tmp___0; // W-W dependency
schedule_irq();
    if (err___0 != 0) { // R-W dependency
      return (err___0);
    } else {
...
schedule_irq();
  protocols = available_protocols; // W-W dependency
schedule_irq();
...
void ldv_mutex_lock_ir_raw_handler_lock(struct mutex *lock )
{
  ...
  {
schedule_irq();
  if (ldv_mutex_ir_raw_handler_lock == 1) { // R-W dependency

  } else {
    ldv_error();
  }
schedule_irq();
  ldv_mutex_ir_raw_handler_lock = 2; // W-W dependency
schedule_irq();
  return;
}
}
...
void ldv_mutex_unlock_ir_raw_handler_lock(struct mutex *lock )
{
  ...
  {
schedule_irq();
  if (ldv_mutex_ir_raw_handler_lock == 2) { // R-W dependency

  } else {
    ldv_error();
  }
schedule_irq();
  ldv_mutex_ir_raw_handler_lock = 1; // W-W dependency
schedule_irq();
  return;
}
}
