# 1 "blink_bug_por_seq.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "blink_bug_por_seq.c"
# 35 "blink_bug_por_seq.c"
unsigned short _R0;
unsigned short _R1;
unsigned short _R2;
unsigned short _R3;
...
schedule_irq();
  bool a = (SchedulerBasicP_m_next[id] != SchedulerBasicP_NO_TASK);
schedule_irq();
  bool b = (SchedulerBasicP_m_tail == id);
schedule_irq();
  return a || b;
}
...
{
schedule_irq();
  int unsigned result = Msp430TimerP_1_Timer_get();
schedule_irq();
  return result;
}
...
{
schedule_irq();
  uint16_t result = Msp430CounterC_0_Msp430Timer_get();
schedule_irq();
  return result;
}
...
{
schedule_irq();
  bool result = Msp430CounterC_0_Msp430Timer_isOverflowPending();
schedule_irq();
  return result;
}
...
{
schedule_irq();
  char unsigned result = Msp430CounterC_0_Counter_isOverflowPending();
schedule_irq();
  return result;
}
...
{
schedule_irq();
  TransformAlarmC_0_to_size_type result=TransformAlarmC_0_Counter_get();
schedule_irq();
  return result;
}
...
{
schedule_irq();
  uint32_t result = AlarmToTimerC_0_Alarm_getNow();
schedule_irq();
  return result;
}
...
void main(void) {
  ...
  enable_irq(1);
  schedule_irq();
# 3844 "blink_bug_por_seq.c"
}
# 3873 "blink_bug_por_seq.c"
static void MotePlatformC_TOSH_FLASH_M25P_DP_bit(bool set)
{
  if(set)
  {
...
schedule_irq();
          ...
          __VERIFIER_assert(timer->isrunning == FALSE);
