...
schedule_irq();
  brake_acc_nodiv_ctrl_B_local.RT_h = RT_Buffer0; // R-W dependency

  /* RateTransition: '<Root>/RT4' */
schedule_irq();
  brake_acc_nodiv_ctrl_B_local.RT4 = RT4_Buffer0; // R-W dependency
...
schedule_irq();
  brake_acc_nodiv_ctrl_B_local.RT1 = RT1_Buffer0; // R-W dependency
...
schedule_irq();
  RT12 = rtb_to_int1; // W-W dependency
schedule_irq();
...
schedule_irq();
  brake_acc_nodiv_ctrl_B_local.RT3 = RT3_Buffer0; // R-W dependency

  /* End of RateTransition: '<Root>/RT3' */

  /* RateTransition: '<Root>/RT11' */
schedule_irq();
  RT11 = rtb_to_int_k; // W-W dependency
schedule_irq();
