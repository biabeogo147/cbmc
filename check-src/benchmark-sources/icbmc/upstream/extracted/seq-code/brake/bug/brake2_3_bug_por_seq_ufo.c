...
schedule_irq();
  vkmh = (((RT9 + RT10) + RT11) + RT12) * // R-W dependency
  ...
  {
schedule_irq();
    real_T tmp = (((RT9 + RT10) + RT11) + RT12) * // R-W dependency
    brake_acc_nodiv_ctrl_P.average_rpm_Gain * brake_acc_nodiv_ctrl_P.wgrads_Gain
    * brake_acc_nodiv_ctrl_P.vkmh_Gain;
   ...
   */
schedule_irq();
  RT_Buffer0 = brake_acc_nodiv_ctrl_P.Distribution_Gain // W-W dependency
    [0] * brake_acc_nodiv_ctrl_B_local.RT14;

  /* Update for RateTransition: '<Root>/RT4' */
schedule_irq();
  RT4_Buffer0 = vkmh; // W-W dependency

  /* Update for RateTransition: '<Root>/RT1' */
schedule_irq();
  RT1_Buffer0 = Distribution_idx; // W-W dependency
schedule_irq();
...
schedule_irq();
  RT3_Buffer0 = Distribution_idx_1; // W-W dependency
schedule_irq();
