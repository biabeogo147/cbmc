# 1 "brake2_3_bug_por_seq.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "brake2_3_bug_por_seq.c"
# 27 "brake2_3_bug_por_seq.c"
...
# 36 "brake2_3_bug_por_seq.c" 2
# 1 "cbmc-math.c" 1
# 37 "brake2_3_bug_por_seq.c" 2
...
const int __CPROVER_thread_priorities[] = {5, 5, 5, 2};
const char* __CPROVER_threads[] = {"c::task_RR_Wheel", "c::task_FL_Wheel",
                                   "c::task_FR_Wheel", "c::task_compute"};

int num_irqs = 4;
int count = 4;

int irq_enabled[] = {0, 0, 0, 0};
...
# 147 "brake2_3_bug_por_seq.c"
extern void brake_acc_nodiv_ctrl_initialize(void);
extern void brake_acc_nodiv_ctrl_terminate(void);
extern void brake_acc_nodiv_ctrl_step(int_T tid);
# 169 "brake2_3_bug_por_seq.c"
