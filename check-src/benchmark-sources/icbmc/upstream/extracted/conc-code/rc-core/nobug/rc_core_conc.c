...
void __VERIFIER_atomic_TRANS_atomic_assume_store_protocols_ldvwrapper(void) {
__VERIFIER_assume(__TRANS_thread_running[1]==0 && __TRANS_thread_running[2]==0);
}

void TRANS_atomic_assume_store_protocols_ldvwrapper(void) {
__VERIFIER_assume(__TRANS_thread_running[1]==0 && __TRANS_thread_running[2]==0);
}

void __VERIFIER_atomic_TRANS_store_protocols_ldvwrapper_enter_thread() {
__VERIFIER_assume(__TRANS_thread_running[1]==0 && __TRANS_thread_running[2]==0);
__TRANS_thread_running[0]=1;
__VERIFIER_assume(__TRANS_thread_running[1]==0 && __TRANS_thread_running[2]==0);
}

void __VERIFIER_atomic_TRANS_store_protocols_ldvwrapper_leave_thread() {
__VERIFIER_assume(__TRANS_thread_running[1]==0 && __TRANS_thread_running[2]==0);
__TRANS_thread_running[0]=0;
__VERIFIER_assume(__TRANS_thread_running[1]==0 && __TRANS_thread_running[2]==0);
}

void __VERIFIER_atomic_TRANS_atomic_assume_show_protocols_ldvwrapper(void) {
__VERIFIER_assume(__TRANS_thread_running[2]==0);
}

void TRANS_atomic_assume_show_protocols_ldvwrapper(void) {
__VERIFIER_assume(__TRANS_thread_running[2]==0);
}

void __VERIFIER_atomic_TRANS_show_protocols_ldvwrapper_enter_thread() {
__VERIFIER_assume(__TRANS_thread_running[2]==0);
__TRANS_thread_running[1]=1;
__VERIFIER_assume(__TRANS_thread_running[2]==0);
}

void __VERIFIER_atomic_TRANS_show_protocols_ldvwrapper_leave_thread() {
__VERIFIER_assume(__TRANS_thread_running[2]==0);
...
/*
void __VERIFIER_atomic_TRANS_atomic_assume_ir_devnode_ldvwrapper(void) {
__VERIFIER_assume(1);
}

void TRANS_atomic_assume_ir_devnode_ldvwrapper(void) {
__VERIFIER_assume(1);
}
*/

void __VERIFIER_atomic_TRANS_ir_devnode_ldvwrapper_enter_thread() {
__TRANS_thread_running[2]=1;
}

void __VERIFIER_atomic_TRANS_ir_devnode_ldvwrapper_leave_thread() {
...
const int __CPROVER_thread_priorities[] = {2, 5, 8};
const char* __CPROVER_threads[] = { "c::store_protocols_ldvwrapper", "c::show_protocols_ldvwrapper", "c::ir_devnode_ldvwrapper"};
...
*/
 ...
 //pthread_join(rc_dev_release_ldvthread, ((void *)0));
...
int ir_raw_event_store_edge(struct rc_dev *dev , enum raw_event_type type )
{
  ...
  } else if ((int )(dev->raw)->last_type & 1) {
    ev.pulse = 0U;
    rc = ir_raw_event_store(dev, & ev);
  } else if (((unsigned int )(dev->raw)->last_type & 2U) != 0U) {
    ev.pulse = 1U;
    rc = ir_raw_event_store(dev, & ev);
  } else {
    return (0);
...
int ir_raw_event_store_with_filter(struct rc_dev *dev , struct ir_raw_event *ev )
{
  ...
  if ((dev->raw)->this_ev.ldv_21014.duration == 0U) {
    (dev->raw)->this_ev = *ev;
  } else if ((int )ev->pulse == (int )(dev->raw)->this_ev.pulse) {
