...
(time $ESBMC --timeout 30m --memlimit 15g --64 --unwind 1 --no-unwinding-assertions --no-assertions --error-label ERROR --no-bounds-check --no-div-by-zero-check --no-pointer-check $fileName &> $dataName'_esbmc.txt') &>> $timeName'_esbmc.txt'
