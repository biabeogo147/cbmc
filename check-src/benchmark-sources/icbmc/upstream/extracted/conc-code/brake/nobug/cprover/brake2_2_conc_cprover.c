...
__CPROVER_assume(__TRANS_thread_running[0]==0 && __TRANS_thread_running[2]==0 && __TRANS_thread_running[3]==0);
}
...
__CPROVER_assume(__TRANS_thread_running[0]==0 && __TRANS_thread_running[1]==0 && __TRANS_thread_running[3]==0);
}
