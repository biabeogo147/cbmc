...
__VERIFIER_assume(__TRANS_thread_running[0]==0 && __TRANS_thread_running[2]==0 && __TRANS_thread_running[3]==0);
}
...
__VERIFIER_assume(__TRANS_thread_running[0]==0 && __TRANS_thread_running[1]==0 && __TRANS_thread_running[3]==0);
}
