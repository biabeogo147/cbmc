...
__VERIFIER_assume(__TRANS_thread_sync[0]==1 && __TRANS_thread_sync[1]==1 && __TRANS_thread_sync[2]==1);
}
...
int_T main(int_T argc, const char *argv[])
{
  ...
  while (1) 
  {
    ...
    pthread_create(&t3, NULL, task_compute, NULL);
