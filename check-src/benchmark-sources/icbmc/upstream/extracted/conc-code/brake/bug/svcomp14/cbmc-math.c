...
{
  double q,r;
  __VERIFIER_assume(floor(q)==q); //q must be integral //TODO: cheaper solution
  __VERIFIER_assume((a==n*q+r) && fabs(r)<fabs(n));
  __VERIFIER_assume((a<0 && r<0) || (a>0 && r>0) || (a==0 && r==0)); //r must have sign of a
  return r;
}
#endif
...
{
  float q,r;
  __VERIFIER_assume(floorf(q)==q); //q must be integral //TODO: cheaper solution
  __VERIFIER_assume((a==n*q+r) && fabsf(r)<fabsf(n));
  __VERIFIER_assume((a<0 && r<0) || (a>0 && r>0) || (a==0 && r==0)); //r must have sign of a
  return r;
}
#endif
