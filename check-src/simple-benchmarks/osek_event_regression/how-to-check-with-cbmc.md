...
```bash
cbmc \
  check-src/simple-benchmarks/osek_event_regression/osek-event-basic/main.c \
  --os-api osek \
  --osek-oil check-src/simple-benchmarks/osek_event_regression/osek-event-basic/config.oil
```
...
```bash
cbmc \
  check-src/simple-benchmarks/osek_event_regression/osek-event-wait-block/main.c \
  --os-api osek \
  --osek-oil check-src/simple-benchmarks/osek_event_regression/osek-event-wait-block/config.oil
```
...
```bash
cbmc \
  check-src/simple-benchmarks/osek_event_regression/osek-event-wait-noblock/main.c \
  --os-api osek \
  --osek-oil check-src/simple-benchmarks/osek_event_regression/osek-event-wait-noblock/config.oil
```
...
```bash
cbmc \
  check-src/simple-benchmarks/osek_event_regression/osek-event-multi-bits/main.c \
  --os-api osek \
  --osek-oil check-src/simple-benchmarks/osek_event_regression/osek-event-multi-bits/config.oil
```
...
```bash
pwsh -File check-src/simple-benchmarks/osek_event_regression/sync_to_regression.ps1
```
