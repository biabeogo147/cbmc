...
```sh
goto-cc \
  check-src/simple-benchmarks/t_isr_multifile/harness.c \
  check-src/simple-benchmarks/t_isr_multifile/harness_unity.c \
  check-src/simple-benchmarks/t_isr_multifile/isr_define/isr.c \
  check-src/simple-benchmarks/t_isr_multifile/task_define/task.c \
  --interleaving-project-root check-src/simple-benchmarks/t_isr_multifile \
  --interleaving-source-files check-src/simple-benchmarks/t_isr_multifile/isr_define/isr.c \
  --interleaving-output check-src/simple-benchmarks/t_isr_multifile/interleaving_harness.json \
  -o check-src/simple-benchmarks/t_isr_multifile/t_isr_multifile.out
```
...
goto-instrument \
  ...
  --interleaving-source-files check-src/simple-benchmarks/t_isr_multifile/isr_define/isr.c \
  --interleaving-output check-src/simple-benchmarks/t_isr_multifile/interleaving_harness.json \
  check-src/simple-benchmarks/t_isr_multifile/t_isr_multifile.out \
  check-src/simple-benchmarks/t_isr_multifile/t_isr_multifile_optimized.out
```
...
{
  "project": {
    "project_root": "check-src/simple-benchmarks/t_isr_multifile",
...
aib \
  ...
  check-src/simple-benchmarks/t_isr_multifile/interleaving_harness.json \
  check-src/simple-benchmarks/t_isr_multifile_injected \
  check-src/simple-benchmarks/t_isr_multifile_injected/interleaving_harness_injected.json
```

This command:
- reads `interleaving_harness.json`
- copies the whole `check-src/simple-benchmarks/t_isr_multifile` tree to
  `check-src/simple-benchmarks/t_isr_multifile_injected`
...
- if `check-src/simple-benchmarks/t_isr_multifile/.aibignore` exists, excludes matched paths from
...
- `check-src/simple-benchmarks/t_isr_multifile_injected/harness.c`
- `check-src/simple-benchmarks/t_isr_multifile_injected/task_define/task.c`

The ISR source file is copied unchanged:
- `check-src/simple-benchmarks/t_isr_multifile_injected/isr_define/isr.c`
...
and `output_root = check-src/simple-benchmarks/t_isr_multifile_injected`, compile these files:
- `check-src/simple-benchmarks/t_isr_multifile_injected/harness.c`
- `check-src/simple-benchmarks/t_isr_multifile_injected/isr_define/isr.c`
- `check-src/simple-benchmarks/t_isr_multifile_injected/task_define/task.c`
...
goto-cc \
  ...
  check-src/simple-benchmarks/t_isr_multifile_injected/isr_define/isr.c \
  check-src/simple-benchmarks/t_isr_multifile_injected/task_define/task.c \
  -o check-src/simple-benchmarks/t_isr_multifile_injected/t_isr_multifile_injected.out

cbmc \
  check-src/simple-benchmarks/t_isr_multifile_injected/t_isr_multifile_injected.out \
  --function main
```
